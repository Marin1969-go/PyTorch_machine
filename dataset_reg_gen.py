...
total_bk = 10
total_cls = 4
dir_out = 'dataset_gen_reg/dataset_reg'
...
sun = pygame.image.load("dataset_gen_reg/images/sun64.png")
backs = [pygame.image.load(f"dataset_gen_reg/images/back_{n}.png") for n in range(1, total_bk + 1)]
